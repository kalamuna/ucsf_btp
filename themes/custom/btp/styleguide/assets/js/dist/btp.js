...
(function ( btp, $, window, undefined) {
   ...
   */
  citc.sidebarMatchHeight = function(){
    $('#sidebar-second-wrap').matchHeight();
  }
    
  // makes sure onresize doesnt get called too frequently
  // improves page performance
  // http://davidwalsh.name/javascript-debounce-function
  citc.debounce = function(func, wait, immediate) {
    var timeout;
    return function() {
  ...
  citc.onResize = citc.debounce( function(){
    // code here…
  }, 30 );
